...
function normalizeReleaseAsset (scenarioState, response, fixture) {
  // set ID to 1
  setIfExists(response, 'id', fixturizeEntityId.bind(null, scenarioState.ids, 'release-asset'))
  ...
  setIfExists(response, 'browser_download_url', fixturizePath.bind(null, scenarioState))
