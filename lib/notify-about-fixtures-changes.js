...
I’ve run into a problem here. My friend Travis notified me that something changed in GitHub’s APIs. I would usually create a new pull request to let you know about it, or update an existing one. But now there more than one: ${pullRequestNumbers.map(number => `#${number}`).join(', ')}
