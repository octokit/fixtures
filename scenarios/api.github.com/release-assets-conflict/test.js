...
test('Labels', async (t) => {
  ...
  try {
    await axios({
      method: 'post',
      url: `https://uploads.github.com/repos/octokit-fixture-org/release-assets-conflict/releases/1/assets?name=test-upload.txt&label=test`,
      headers: {
        Accept: 'application/vnd.github.v3+json',
        Authorization: 'token 0000000000000000000000000000000000000001',
  ...
  await axios({
    method: 'get',
    url: 'https://api.github.com/repos/octokit-fixture-org/release-assets-conflict/releases/1/assets',
    headers: {
      Accept: 'application/vnd.github.v3+json',
      Authorization: 'token 0000000000000000000000000000000000000001'
    }
  ...
  await axios({
    method: 'delete',
    url: 'https://api.github.com/repos/octokit-fixture-org/release-assets-conflict/releases/assets/1',
    headers: {
      Accept: 'application/vnd.github.v3+json',
      Authorization: 'token 0000000000000000000000000000000000000001'
    }
